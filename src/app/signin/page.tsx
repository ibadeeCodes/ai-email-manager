        ...
        <div className="min-h-screen bg-white flex flex-col">
            <header className="p-4 border-b">
                <div className="container mx-auto flex items-center">
                    ...
                    <h1 className="text-xl font-bold text-gray-800">AI Email Manager</h1>
                </div>
            </header>
            ...
            <main className="flex-grow flex items-center justify-center p-4">
                <Card className="w-full max-w-md bg-gray-100">
                    <CardHeader className="text-center">
                        <CardTitle className="text-2xl font-bold">Sign Up to AI Email Manager</CardTitle>
                        <CardDescription>
            ...
            <footer className="p-4 border-t">
                <div className="container mx-auto text-center text-sm text-gray-500">
                    © 2024 AI Email Manager. All rights reserved.
                </div>
            </footer>
        </div>
    )
